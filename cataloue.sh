...
cp -i \\devopslearn\\draw.io\\repos\\roboshop-shell\\catalogue.service /etc/systemd/system/catalogue.service &>>$LOGFILE
...
cp C:\devopslearn\draw.io\repos\roboshop-shell\mongo.repo  /etc/yum.repos.d/mongo.repo &>>$LOGFILE
