...
cp \\devopslearn\\draw.io\\repos\\roboshop-shell\\catalogue.service /etc/systemd/system/catalogue.service &>>$LOGFILE
...
cp /C:/devopslearn/draw.io/repos/roboshop-shell  /etc/yum.repos.d/mongo.repo &>>$LOGFILE
